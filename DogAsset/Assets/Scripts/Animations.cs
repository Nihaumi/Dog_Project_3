...
public class Animations : MonoBehaviour
{
    ...
    public List<string> list_turn = new List<string>();
    ...
    void Start()
    {
        ...
        list_turn.Add(turn_left_seek);
        list_turn.Add(turn_right_seek);
        list_turn.Add(turn_left_trot);
        list_turn.Add(turn_right_trot);
    }
